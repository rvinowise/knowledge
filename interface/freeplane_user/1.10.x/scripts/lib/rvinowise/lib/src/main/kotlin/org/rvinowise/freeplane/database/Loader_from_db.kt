...
fun recreate_node_by_db_row(parent_node, node_row) {
...
fun recreate_subtree(root_node) {
...
fun recreate_node_by_db_id(parent_node, id) {
	sql.firstRow(
		"""
...
fun load_icons(node_db_id, dst_node) {
	sql.eachRow(
		"""
