...
<node TEXT="adobe flash" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_696401721" CREATED="1610381621824" MODIFIED="1658315510719"><hook NAME="MapStyle" zoom="1.5">
...
<font NAME="Tahoma"/>
<node TEXT="type: " POSITION="left" ID="ID_120783298" CREATED="1658315510782" MODIFIED="1658315510782"/>
...
<node TEXT="program in javascript for html5" POSITION="right" ID="ID_692747275" CREATED="1658315510782" MODIFIED="1658315552848">
<node ID="ID_1137914026" CREATED="1658315561207" MODIFIED="1658315588953"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <p>
      debug in edge browser in the <b>runtime</b>
    </p>
  </body>
</html>
</richcontent>
<node TEXT="console.log(&quot;msg&quot;)" ID="ID_659439717" CREATED="1658315598834" MODIFIED="1658316365386">
<icon BUILTIN="quote"/>
<font NAME="fira code" SIZE="9"/>
</node>
</node>
<node TEXT="uses library createJs" ID="ID_57073484" CREATED="1658324281111" MODIFIED="1658324293572">
<node TEXT="based on action script, similar to classic flash" ID="ID_638251502" CREATED="1658324295074" MODIFIED="1658324307413"/>
<node TEXT="lib.my_project_name" ID="ID_189515170" CREATED="1658335191788" MODIFIED="1658335202530">
<icon BUILTIN="quote"/>
<font NAME="fira code" SIZE="9"/>
<node TEXT="has all the stuff from the flash scene" ID="ID_1874428562" CREATED="1658335205047" MODIFIED="1658335326716">
<icon BUILTIN="good"/>
</node>
<node TEXT="can be accessed through code in key-frames" ID="ID_1423796343" CREATED="1658335227926" MODIFIED="1658335251452"/>
<node TEXT="trying to expose it to the external code freezes the browser" ID="ID_713521135" CREATED="1658335285968" MODIFIED="1658335317999">
<icon BUILTIN="bad"/>
</node>
</node>
</node>
